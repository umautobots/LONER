...
class MplFrameDrawer:
    ...
    def Update(self):
        ...
        while self._frame_slot.HasValue():
            ...
            new_pose = frame.GetStartLidarPose().GetTransformationMatrix()[:3, 3]
            gt_pose = (self._gt_pose_offset * frame._gt_lidar_start_pose).GetTransformationMatrix()[:3, 3]
