...
class TestFrameSynthesis(unittest.TestCase):
    def test_simple(self):
        ...
        dists = first_frame.lidar_points.timestamps - torch.linspace(0,1.5,10)
        ...
        dists = second_frame.lidar_points.timestamps - torch.linspace(1.6, 3.5,19)
        equal = torch.all(dists < 1e5)
        self.assertTrue(equal)
    ...
    def test_stale_lidar_points(self):
        ...
        self.assertAlmostEqual(second_frame.lidar_points.timestamps[-1].item(), expected_last_val)
